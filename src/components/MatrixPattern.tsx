...
const StyledWrapper = styled.div<{ $theme: string }>`
  ...
  .matrix-column::before {
    ...
    background: ${props => props.$theme === 'dark' 
      ...
      : 'linear-gradient(to bottom, #000000 0%, #000000 5%, #333333 10%, #333333 20%, #666666 30%, #999999 40%, #cccccc 50%, #e6e6e6 60%, #f0f0f0 70%, #f5f5f5 80%, rgba(0, 0, 0, 0.3) 90%, transparent 100%)'
    };
